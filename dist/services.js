...
function getAll() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.query("SELECT * FROM players")];
                case 1:
                    result = _a.sent();
                    ;
...
function postPlayer(player) {
    return __awaiter(this, void 0, void 0, function () {
        var name, rank, points, result, status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = player.name, rank = player.rank, points = player.points;
                    return [4 /*yield*/, connection.query("\n    INSERT INTO players (name, rank, points) VALUES ($1, $2, $3)\n  ", [name, rank, points])];
                case 1:
                    result = _a.sent();
                    ;
                    status = result.rowCount ? 201 : 400;
                    return [2 /*return*/, status];
            }
        });
    });
}
function updatePlayerById(points, id) {
    return __awaiter(this, void 0, void 0, function () {
        var result, status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    status = result.rowCount ? 200 : 400;
                    return [2 /*return*/, status];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    status = result.rowCount ? 204 : 400;
                    return [2 /*return*/, status];
            }
        });
    });
...
export var services = {
    getAll: getAll,
    getPlayerByRank: getPlayerByRank,
